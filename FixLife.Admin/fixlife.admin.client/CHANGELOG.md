...
- Create Angular project with ng: `ng new fixlife.admin.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`fixlife.admin.client.esproj`).
